...
<head>
    ...
    <title>Laveral 10 Task List App</title>
    ...
    <style type="text/tailwindcss">
        ...
        label {
            @apply block mb-2 font-medium text-slate-700
        }

        input, textarea {
            @apply w-full border border-slate-500 rounded-md px-3 py-2 mb-2 shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-slate-400 focus:border-transparent
        }
